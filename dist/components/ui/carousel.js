...
function Carousel(_a) {
    ...
    return (_jsx(CarouselContext.Provider, { value: {
        ...
        }, children: _jsx("div", __assign({ onKeyDownCapture: handleKeyDown, className: cn("relative", className), role: "region", "aria-roledescription": "carousel", "data-slot": "carousel" }, props, { children: children })) }));
}
