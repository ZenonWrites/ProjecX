...
function ContextMenuTrigger(_a) {
    var props = __rest(_a, []);
    return (_jsx(ContextMenuPrimitive.Trigger, __assign({ "data-slot": "context-menu-trigger" }, props)));
}
...
function ContextMenuLabel(_a) {
    ...
    return (_jsx(ContextMenuPrimitive.Label, __assign({ "data-slot": "context-menu-label", "data-inset": inset, className: cn("text-foreground px-2 py-1.5 text-sm font-medium data-[inset]:pl-8", className) }, props)));
}
...
function ContextMenuShortcut(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsx("span", __assign({ "data-slot": "context-menu-shortcut", className: cn("text-muted-foreground ml-auto text-xs tracking-widest", className) }, props)));
}
